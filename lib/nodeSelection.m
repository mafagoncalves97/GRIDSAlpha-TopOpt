...
%>afterwards.
%======================================================================
function [fixedNodes, sSnodes, loads]=nodeSelection(nodeCoord, connectInfo)

%Separating nodal coordinates into vectors
xData=nodeCoord(:,2);
yData=nodeCoord(:,3);
%Array with different window titles
strTitle={'Select fixed nodes...','Select simply supported nodes...',...
          'Select nodes with applied loads...'};
%Keywords for BC definition
bcType={'fixedNodes','sSnodes','loads'};

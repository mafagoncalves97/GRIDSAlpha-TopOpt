function [elementK]=elStiffnessTopOptThermal(nodeShapeFun, intPts, elNodeCoord, dOf,...
                                                   elNodes,connectInfo, C,elThick)
...
%         B(3,m)=dNdXdY(1,:);        
        ...
        z=[1:4];
        elK(z,z) = elK(z,z)+ B'*C*B*wCsi*wEta*det(J)*elThick;
      
        
    end  
    
elementK(:,:,i)=elK;    
elK=zeros(dOf*elNodes,dOf*elNodes);
%% Output
